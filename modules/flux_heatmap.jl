...
function plot_coordinate33!(fig, latitude, longitude, altitude; title="")
  ...
  for i in 1:3, j in 1:3
    ...
    hm = heatmap!(ax, longitude, latitude, flux; colormap=:inferno)
